...
// ********************************************************************
//
// $Id: exampleP1.cc 86065 2014-11-07 08:51:15Z gcosmo $
//
/// \file exampleP1.cc
/// \brief Main program of the P1 example
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new P1DetectorConstruction());
  ...
  runManager->SetUserInitialization(new P1ActionInitialization());
