...
{  
  ...
  { 2.034*eV, 2.068*eV, 2.103*eV, 2.139*eV,
    ...
    // Values from EJ305-em.xls data table. To be incorporated... 
//        G4double photonEnergy[] =
//        { 3.139*eV, 3.108*eV, 3.092*eV, 3.077*eV,
//          3.047*eV, 3.017*eV, 2.988*eV, 2.960*eV,
//          2.946*eV, 2.939*eV, 2.932*eV, 2.925*eV,
//          2.918*eV, 2.911*eV, 2.904*eV, 2.898*eV,
//          2.891*eV, 2.878*eV, 2.864*eV, 2.851*eV,
//          2.825*eV, 2.800*eV, 2.775*eV, 2.750*eV,
//          2.726*eV, 2.702*eV, 2.691*eV, 2.679*eV,
//          2.668*eV, 2.656*eV, 2.634*eV, 2.612*eV,
//          2.590*eV, 2.568*eV, 2.547*eV, 2.527*eV,
//          2.506*eV, 2.486*eV, 2.467*eV, 2.447*eV,
//          2.428*eV, 2.409*eV, 2.391*eV, 2.372*eV,
//          2.354*eV, 2.486*eV, 2.467*eV, 2.447*eV,
//          2.428*eV, 2.409*eV, 2.391*eV, 2.372*eV,
//          2.354*eV };
//        G4double scintilFast[] =
//        { 0.000, 0.010 ,0.020, 0.050,
//          0.180, 0.350, 0.600, 0.870,
//          0.960, 0.982, 0.993, 1.000,
//          0.996, 0.992, 0.982, 0.970,
//          0.955, 0.925, 0.895, 0.855,
//          0.750, 0.660, 0.580, 0.520,
//          0.470, 0.430, 0.415, 0.395,
//          0.368, 0.340, 0.270, 0.215,
//          0.173, 0.138, 0.110, 0.090,
//          0.070, 0.055, 0.040, 0.032,
//          0.025, 0.017, 0.012, 0.007,
//          0.004, 0.055, 0.040, 0.032,
//          0.025, 0.017, 0.012, 0.007,
//          0.004 };
